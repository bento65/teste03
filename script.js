...
document.getElementById('messageBtn').addEventListener('click', function() {
    ...
    const paragraphs = [
        ...
        "Que você continue a iluminar o caminho de todos ao seu redor com sua luz única. Saiba que sua presença é um presente inestimável em nossas vidas.",
        "Neste dia especial, desejo a você toda a alegria do mundo. Que seus sonhos mais queridos se realizem e que cada novo dia traga novas razões para sorrir. Você merece tudo de melhor que a vida pode oferecer.",
